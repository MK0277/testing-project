        ...
        <ul class="nav pcoded-inner-navbar ">
          ...
          <li class="nav-item pcoded-hasmenu">
            <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span
                class="pcoded-mtext">Page layouts</span></a>
           ...
           <li class="nav-item">
            <a href="college-project-application.html" class="nav-link "><span class="pcoded-micon"><i
                  class="feather icon-file-text"></i></span><span class="pcoded-mtext">College Project Application</span></a>
          </li>
          <li class="nav-item">
            <a href="upload-notes-syllabus.html" class="nav-link "><span class="pcoded-micon"><i
                  class="feather icon-file-text"></i></span><span class="pcoded-mtext">Upload Notes /
                Syllabus</span></a>
          </li>
          <li class="nav-item pcoded-menu-caption">
              ...
              <div class="row no-gutters">
                ...
                <div class="col">
                  ...
                  <ul class="pro-body">
                    ...
                    <li><a href="#!" class="dropdown-item"><i class="feather icon-upload-cloud"></i> File upload</a>
                    </li>
          ...
          <div class="dropdown drp-user">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-notification">
              ...
              <ul class="pro-body">
                ...
                <li><a href="email_inbox.html" class="dropdown-item"><i class="feather icon-mail"></i> My Messages</a>
                </li>
                <li><a href="auth-signin.html" class="dropdown-item"><i class="feather icon-lock"></i> Lock Screen</a>
                </li>
              </ul>
            </div>
          </div>
